# Generated by Powerlevel10k configuration wizard on 2025-07-12 at 17:05 -03.
...
# round separators, blurred heads, blurred tails, 2 lines, solid, no frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='$(python --version 2>&1 | cut -d" " -f2)'
